...
BEGIN
  ...
  -- Empleados NO pueden modificar campos financieros / dirección / asignación.
  -- `ganancia` no se valida aquí porque es una columna generada por PostgreSQL;
  -- cambia sola al cambiar `estado` y antes bloqueaba finalizar/cancelar.
